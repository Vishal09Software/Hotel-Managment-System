                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2">{{App\Models\Booking::count()}}+</p>
                      {{-- <p>10.00% (30 days)</p> --}}
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                  <div class="card card-light-blue">
                    <div class="card-body">
                      <p class="mb-4">Rooms</p>
                      <p class="fs-30 mb-2">{{App\Models\Room::count()}}+</p>
                      {{-- <p>2.00% (30 days)</p> --}}
                    </div>
                  </div>
                </div>
                <div class="col-md-6 stretch-card transparent">
                  <div class="card card-light-danger">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2">{{App\Models\Staff::count()}}+</p>
                      {{-- <p>0.22% (30 days)</p> --}}
                    </div>
                  </div>
                </div>
