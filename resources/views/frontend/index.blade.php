...
@section('main-container')
    ...
    <header class="header slider-fade">
        <div class="owl-carousel owl-theme">
            <div class="text-center item bg-img" data-overlay-dark="2" data-background="{{ url('frontend/img/slider/2.jpg')}}">
            ...
            <div class="text-center item bg-img" data-overlay-dark="2" data-background="{{ url('frontend/img/slider/3.jpg')}}">
                <div class="v-middle caption">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-10 offset-md-1">
            ...
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ url('frontend/img/slider/1.jpg')}}">
                <div class="v-middle caption">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-10 offset-md-1">
    ...
    <section class="rooms1 section-padding bg-cream" data-scroll-index="1">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="item">
                        <div class="position-re o-hidden"> <img src="{{ url('frontend/img/rooms/1.jpg')}}" alt=""> </div> <span class="category"><a href="rooms2.html">Book</a></span>
                        <div class="con">
                ...
                <div class="col-md-4">
                    <div class="item">
                        <div class="position-re o-hidden"> <img src="{{ url('frontend/img/rooms/2.jpg')}}" alt=""> </div> <span class="category"><a href="rooms2.html">Book</a></span>
                        <div class="con">
                ...
                <div class="col-md-4">
                    <div class="item">
                        <div class="position-re o-hidden"> <img src="{{ url('frontend/img/rooms/3.jpg')}}" alt=""> </div> <span class="category"><a href="rooms2.html">Book</a></span>
                        <div class="con">
                ...
                <div class="col-md-6">
                    <div class="item">
                        <div class="position-re o-hidden"> <img src="{{ url('frontend/img/rooms/4.jpg')}}" alt=""> </div> <span class="category"><a href="rooms2.html">Book</a></span>
                        <div class="con">
                ...
                <div class="col-md-6">
                    <div class="item">
                        <div class="position-re o-hidden"> <img src="{{ url('frontend/img/rooms/7.jpg')}}" alt=""> </div> <span class="category"><a href="rooms2.html">Book</a></span>
                        <div class="con">
                            <h6><a href="room-details.html">150$ / Night</a></h6>
    ...
    <section class="testimonials">
        <div class="background bg-img bg-fixed section-padding pb-0" data-background="{{ url('frontend/img/slider/2.jpg')}}" data-overlay-dark="3">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <div class="testimonials-box">
                            ...
                            <div class="owl-carousel owl-theme">
                                <div class="item">
                                    <span class="quote"><img src="{{ url('frontend/img/quot.png')}}" alt=""></span>
                                    ...
                                    <div class="info">
                                        <div class="author-img"> <img src="{{ url('frontend/img/team/4.jpg')}}" alt=""> </div>
                                ...
                                <div class="item">
                                    ...
                                    <p>Hotel dapibus asue metus the nec feusiate eraten miss hendreri net ve ante the lemon sanleo nectan feugiat erat hendrerit necuis ve ante otel inilla duiman at finibus viverra neca the sene on satien the miss drana inc fermen norttito sit space, mus nellentesque habitan.</p>
                                    <div class="info">
                                        <div class="author-img"> <img src="{{ url('frontend/img/team/1.jpg')}}" alt=""> </div>
                                        <div class="cont"> <span><i class="star-rating"></i><i class="star-rating"></i><i class="star-rating"></i><i class="star-rating"></i><i class="star-rating"></i></span>
                                ...
                                <div class="item">
                                    ...
                                    <p>Hotel dapibus asue metus the nec feusiate eraten miss hendreri net ve ante the lemon sanleo nectan feugiat erat hendrerit necuis ve ante otel inilla duiman at finibus viverra neca the sene on satien the miss drana inc fermen norttito sit space, mus nellentesque habitan.</p>
                                    <div class="info">
                                        <div class="author-img"> <img src="{{ url('frontend/img/team/5.jpg')}}" alt=""> </div>
                                        <div class="cont"> <span><i class="star-rating"></i><i class="star-rating"></i><i class="star-rating"></i><i class="star-rating"></i><i class="star-rating"></i></span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 p-0 animate-box" data-animate-effect="fadeInLeft">
                    <div class="img left">
                        <a href="restaurant.html"><img src="{{ url('frontend/img/restaurant/1.jpg')}}" alt=""></a>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="position-re o-hidden"> <img src="{{ url('frontend/img/news/1.jpg')}}" alt="">
                                <div class="date">
                        ...
                        <div class="item">
                            <div class="position-re o-hidden"> <img src="{{ url('frontend/img/news/2.jpg')}}" alt="">
                                <div class="date">
                        ...
                        <div class="item">
                            <div class="position-re o-hidden"> <img src="{{ url('frontend/img/news/3.jpg')}}" alt="">
                                <div class="date">
                        ...
                        <div class="item">
                            <div class="position-re o-hidden"> <img src="{{ url('frontend/img/news/4.jpg')}}" alt="">
                                <div class="date">
                        ...
                        <div class="item">
                            <div class="position-re o-hidden"> <img src="{{ url('frontend/img/news/6.jpg')}}" alt="">
                                <div class="date">
                                    <a href="post.html"> <span>Dec</span> <i>08</i> </a>
                                </div>
                            </div>
                        ...
                        <div class="item">
                            <div class="position-re o-hidden"> <img src="{{ url('frontend/img/news/5.jpg')}}" alt="">
                                <div class="date">
                                    <a href="post.html"> <span>Dec</span> <i>08</i> </a>
                                </div>
                            </div>
    ...
    <section class="testimonials">
        <div class="background bg-img bg-fixed section-padding pb-0" data-background="{{ url('frontend/img/slider/2.jpg')}}" data-overlay-dark="2">
            <div class="container">
                <div class="row">
                    <!-- Reservation -->
