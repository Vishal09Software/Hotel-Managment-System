...
<script src="{{ url('frontend/js/jquery-migrate-3.0.0.min.js')}}"></script>
<script src="{{ url('frontend/js/modernizr-2.6.2.min.js')}}"></script>
<script src="{{ url('frontend/js/imagesloaded.pkgd.min.js')}}"></script>
<script src="{{ url('frontend/js/jquery.isotope.v3.0.2.js')}}"></script>
<script src="{{ url('frontend/js/pace.js')}}"></script>
...
<script src="{{ url('frontend/js/YouTubePopUp.js')}}"></script>
